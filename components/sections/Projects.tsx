      ...
      <div className="container mx-auto">
        ...
        >
          {projectList.map((project: any, index: number) => {
            ...
            <div
              key={project._id}
              className={`project-card group relative overflow-hidden rounded-xl bg-surface-container backdrop-blur-sm hover:bg-surface-container-high transition-all duration-500 hover:scale-[1.02] ${
            ...
            >
              ...
              <div className="relative p-6 h-full flex flex-col justify-between min-h-[280px]">
                ...
                <div className="flex gap-3">
                  <a
                    ...
                    className="group/link flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-primary to-[#ff7948] text-primary-foreground rounded-full font-body font-medium hover:shadow-lg hover:shadow-primary/25 transition-all duration-300 hover:scale-105"
                  >
                    <svg
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group/link flex items-center justify-center w-10 h-10 bg-surface-bright hover:bg-primary/10 rounded-xl transition-all duration-300 hover:scale-110"
                    aria-label="GitHub Repository"
                  >
                    <svg
                      className="w-5 h-5 fill-current group-hover/link:scale-110 group-hover/link:text-primary transition-all"
                      viewBox="0 0 24 24"
                    >
              ...
              {/* Hover Effect Border - subtle ghost border */}
              <div className="absolute inset-0 outline outline-1 outline-transparent group-hover:outline-border rounded-xl pointer-events-none transition-all duration-500"></div>
            </div>
          )})}
        </div>
