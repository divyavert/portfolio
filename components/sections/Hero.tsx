...
export function Hero({ personalInfo }: HeroProps) {
  ...
  const profileImage = personalInfo?.profileImage
    ? urlFor(personalInfo.profileImage).width(400).height(400).url()
    : null;
  ...
  return (
    ...
    >
      ...
      <div className='container mx-auto relative z-10'>
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
          ...
          <div ref={profileCardRef} className='perspective-1000'>
            <div className='bg-surface-container backdrop-blur-md rounded-xl p-8 shadow-2xl relative overflow-hidden group'>
              {/* Card glow effect */}
              ...
              <div className='relative z-10'>
                ...
                <p className='text-center text-primary font-body font-medium mb-2 text-lg'>
                  {tagline}
                </p>

                <p className='text-center text-muted-foreground font-body mb-6 text-sm leading-relaxed px-4'>
                  Crafting innovative solutions with clean code and creative
                  thinking
                </p>
                ...
                <div className='flex justify-center gap-3'>
                  <a
                    ...
                    className='group/social w-12 h-12 rounded-xl bg-surface-bright hover:bg-primary/10 flex items-center justify-center transition-all duration-300 hover:scale-110'
                    aria-label='GitHub'
                  >
                    <svg
                      className='w-5 h-5 fill-current group-hover:text-primary transition-colors'
                      viewBox='0 0 24 24'
                    >
          ...
          <div>
            ...
            <p
              ref={subtitleRef}
              className='text-lg md:text-xl text-muted-foreground font-body mb-8 max-w-lg leading-relaxed'
            >
              Passionate about creating{' '}
              <span className='text-primary font-medium'>intuitive</span> and{' '}
              <span className='text-primary font-medium'>engaging</span> user
              experiences. Transforming ideas into beautifully crafted digital
              products.
            </p>
            ...
            <a
              ...
              href={resumeUrl}
              download
              className='group inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-primary to-[#ff7948] text-primary-foreground rounded-full font-body font-medium hover:shadow-lg hover:shadow-primary/25 transition-all duration-300 hover:scale-105'
            >
              <svg
      ...
      <div className='absolute bottom-4 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 animate-bounce'>
        <span className='text-xs text-muted-foreground font-label uppercase tracking-wider'>
          SCROLL
        </span>
        <svg
