    ...
    >
      ...
      <div className="container mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative z-10">
                ...
                <div className="w-48 h-48 mx-auto mb-6 rounded-xl bg-gradient-to-br from-primary/20 to-accent-purple/20 flex items-center justify-center text-6xl relative overflow-hidden">
                  ...
                  {profileImage ? (
                    ...
                    <span className="relative z-10 font-display">{name.split(' ').map(n => n[0]).join('')}</span>
                  )}
                </div>
                ...
                <div className="flex justify-center gap-3">
                  <a
                    ...
                    aria-label="GitHub"
                  >
                    <svg className="w-5 h-5 fill-current group-hover:text-primary transition-colors" viewBox="0 0 24 24">
          ...
          {/* Right - Title & Stats */}
          <div>
            <h1 ref={titleRef} className="text-5xl md:text-7xl lg:text-8xl font-display font-bold mb-6 leading-tight">
            ...
            <p ref={subtitleRef} className="text-lg md:text-xl text-muted-foreground font-body mb-8 max-w-lg leading-relaxed">
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 animate-bounce">
        <span className="text-xs text-muted-foreground font-label uppercase tracking-wider">SCROLL</span>
